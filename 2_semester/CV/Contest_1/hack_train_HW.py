...
from hack_utils import ScaleMinSideToSize, CropCenter, TransformByKeys, \
                        BrightnessContrastAugmenter, BlurAugmenter, RandomAugmentation
...
def train(model, loader, loss_fn, optimizer, device):
    ...
    train_loss = []
    num_iterations = None
    if args.test: num_iterations = 100
    for batch in tqdm.tqdm(loader, total=num_iterations, desc="training..."):
